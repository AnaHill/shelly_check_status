...
**Scheduling:** Single cron at `0 6 * * *` UTC. Checks *yesterday's* data so GitHub's cron delays (often 30–90 min) don't matter — the data is always complete by then. No DST handling needed.
